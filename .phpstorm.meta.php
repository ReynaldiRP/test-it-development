...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./home/reynaldi/coding-project/test-kerja/test-it-development/public/storage' => 'string',
            ...
            'laravolt.indonesia.cache.ttl' => 'integer',
            'laravolt.indonesia.cache.prefix' => 'string',
            'laravolt.indonesia.cache.store' => 'string',
...
'filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./home/reynaldi/coding-project/test-kerja/test-it-development/public/storage','inertia.ssr.enabled',
'inertia.ssr.url','inertia.ensure_pages_exist','inertia.page_paths','inertia.page_extensions','inertia.testing.ensure_pages_exist',
'inertia.testing.page_paths','inertia.testing.page_extensions','inertia.history.encrypt','laravolt.indonesia.table_prefix','laravolt.indonesia.route.enabled',
'laravolt.indonesia.route.middleware','laravolt.indonesia.route.prefix','laravolt.indonesia.view.layout','laravolt.indonesia.menu.enabled','laravolt.indonesia.cache.ttl',
'laravolt.indonesia.cache.prefix','laravolt.indonesia.cache.store','logging.default','logging.deprecations.channel','logging.deprecations.trace',
...
'web','api',);
        registerArgumentsSet('routes', 'home','dashboard','customers.index','customers.create',
'customers.store','customers.show','customers.edit','customers.update','customers.destroy','profile.edit','profile.update','profile.destroy','password.edit',
...
'app','indonesia::kabupaten.create','indonesia::kabupaten.edit','indonesia::kabupaten.index','indonesia::kecamatan.create',
'indonesia::kecamatan.edit','indonesia::kecamatan.index','indonesia::kelurahan.create','indonesia::kelurahan.edit','indonesia::kelurahan.index',
'indonesia::provinsi.create','indonesia::provinsi.edit','indonesia::provinsi.index','laravel-exceptions-renderer::components.card','laravel-exceptions-renderer::components.context',
